...
1. **Pesquisa diária** às 07:00 (hora de Lisboa) via Perplexity API
2. **Análise com IA** (Claude) que cruza cada concurso com o perfil da empresa
3. **Geração de proposta** completa com valores concretos maximizados
4. **Dashboard web** sempre disponível para consulta
...
Para adicionar novas queries de pesquisa, edita `SEARCH_QUERIES` em `agent.py`.
